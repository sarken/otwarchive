...
) ENGINE=InnoDB AUTO_INCREMENT=15332966 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=135214 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=19268 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=3570772 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=314472 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=18156 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10376578 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=3847308 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=5645364 DEFAULT CHARSET=utf8;
...
CREATE TABLE `external_work_type_taggings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `external_work_id` int(11) DEFAULT NULL,
  `work_type_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `external_work_types_unique` (`external_work_id`,`work_type_id`),
  KEY `index_external_work_type_taggings_on_work_type_id` (`work_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `external_works` (
  ...
  `language_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35804 DEFAULT CHARSET=utf8;
...
CREATE TABLE `feedbacks` (
  ...
  `language` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20531 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=50787 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=371360 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=159546 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=416591 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=9336973 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=630165 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=61145985 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=117684 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=444418 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=137050 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=479879 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=231382875 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=45416 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=347619 DEFAULT CHARSET=utf8;
...
CREATE TABLE `series` (
  ...
  `notes_sanitizer_version` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=106545 DEFAULT CHARSET=utf8;
...
CREATE TABLE `stat_counters` (
  ...
  UNIQUE KEY `index_hit_counters_on_work_id` (`work_id`),
  KEY `index_hit_counters_on_hit_count` (`hit_count`)
) ENGINE=InnoDB AUTO_INCREMENT=1675301 DEFAULT CHARSET=utf8;
...
CREATE TABLE `subscriptions` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9860868 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2026417 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=444514 DEFAULT CHARSET=utf8;
...
CREATE TABLE `work_type_taggings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `work_id` int(11) DEFAULT NULL,
  `work_type_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_work_type_taggings_on_work_id_and_work_type_id` (`work_id`,`work_type_id`),
  KEY `index_work_type_taggings_on_work_type_id` (`work_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `work_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_work_types_on_name` (`name`)
...
) ENGINE=InnoDB AUTO_INCREMENT=1677530 DEFAULT CHARSET=utf8;
...
INSERT INTO schema_migrations (version) VALUES ('20130218193621');

INSERT INTO schema_migrations (version) VALUES ('20130218201313');

INSERT INTO schema_migrations (version) VALUES ('20130218201505');

INSERT INTO schema_migrations (version) VALUES ('20130218201734');
