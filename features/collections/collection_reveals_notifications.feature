...
Feature: Notification emails for newly revealed collections
  ...
  Scenario: A creator posts a gift work to a moderated unrevealed collection. The moderator approves the work before revealing the collection. Gift notifications for the work are sent and mention the collection name.
  Given the user "recip" exists and is activated
    And I have the unrevealed moderated collection "Unrevealed Moderated Collection"
    And I am logged in as a random user
  ...
  Scenario: A creator posts a prompt fill to a moderated unrevealed collection. The moderator approves the work before revealing the collection. Prompt notifications for the work are sent and mention the collection name.
  Given basic tags
    And the prompt meme "Unrevealed Moderated Prompt Meme" with default settings
    And I am logged in as the owner of "Unrevealed Moderated Prompt Meme"
    And I set the collection "Unrevealed Moderated Prompt Meme" to unrevealed
