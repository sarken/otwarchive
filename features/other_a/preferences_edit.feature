...
Feature: Edit preferences
  ...
  Then I should see "Dashboard" within "#dashboard"
    And I should see "History" within "#dashboard"
    And I should see "Preferences" within "#dashboard"
    And I should see "Profile" within "#dashboard"
  When I follow "Preferences" within "#dashboard"
  Then I should see "Set My Preferences"
