...
Feature: Edit Works
  ...
  Scenario: You can't edit a work unless you're logged in and it's your work
    ...
    Then I should see "Preview"
      ...
      And I should see "Words:3" within "dd.work.stats"
    When I press "Update"
    ...
    When I edit the work "First Work"
      And I follow "2"
      And I fill in "content" with "new content for second chapter"
      And I press "Preview"
      And I follow "Cancel"
    Then I should see "content for second chapter"
      And I should see "Words:8" within "dd.work.stats"
      And I should see "Words: 4" within "dd.chapter.stats"
